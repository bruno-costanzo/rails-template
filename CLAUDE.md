...
- **Design** — DaisyUI themes in OKLCH, warm neutral with one accent. The accessibility gate decides the palette, and the NEUTRALS fail before the accent does. → `design.md`
